...
final items =[
Icon(Icons.person, size: 30, color: index == 0 ? Colors.blue : Colors.black,),
Icon(Icons.home, size: 30, color: index == 1 ? Colors.blue : Colors.black,),
Icon(Icons.location_on, size: 30, color: index == 2 ? Colors.blue : Colors.black,),
];
  return Scaffold(
    appBar: AppBar(
      centerTitle: true,
